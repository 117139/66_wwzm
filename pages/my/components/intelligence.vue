<template>
	<view class="content_wrap" :class="tk_show?'tk_class':''">
		...
		<view class="my_list" >
			<view class="my_li" @tap="jump" data-url="/pages/my_zuzhi/my_zuzhi" :data-login='true' :data-haslogin='hasLogin'>
				<view class="my_icon"><text class="iconfont icon-guanyuwomen"></text></view>
				<view class="flex_1">组织架构信息</view>
			...
			<view  class="my_li" @tap="jump" data-url="../my_pwd/my_pwd" :data-login='true' :data-haslogin='hasLogin'>
				<view class="my_icon"><text class="iconfont icon-yinsi"></text></view>
				<view class="flex_1">修改密码</view>
				<text class="iconfont icon-next-m"></text>
			</view>
			<button v-if="hasLogin" class="my_li dis_flex aic ju_b" open-type="getPhoneNumber" @getphonenumber="onGetPhoneNumber">
				<view class="my_icon"><text class="iconfont icon-kefu"></text></view>
				<view class="flex_1">修改手机</view>
				<text class="iconfont icon-next-m"></text>
			</button>
		</view>
